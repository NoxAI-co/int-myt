...
Route::get('ingresos', 'IngresosController@ingresos')->name('ingreso');
...
Route::group(['prefix' => 'empresa', 'middleware' => ['auth']], function() {
	...
	Route::group(['prefix' => 'inventario'], function() {
		...
		Route::post('/publicar/{id}', 'InventarioController@publicar')->name('inventario.publicar');
		Route::get('/modems', 'InventarioController@modems')->name('inventario.modems');
		Route::get('/material-wifi', 'InventarioController@material')->name('inventario.wifi.material');
        Route::get('/television', 'InventarioController@television')->name('inventario.television');
        Route::get('/television/create', 'InventarioController@television_create')->name('inventario.television_create');
	...
	Route::group(['prefix' => 'facturas'], function() {
		...
		Route::get('tirilla/whatsapp/{id}/{name}', 'FacturasController@imprimirTirillaWhatsapp')->name('facturas.tirilla.whatsapp');
		Route::get('tirilla/whatsapp/ingreso/{id}/{name}', 'FacturasController@imprimirTirillaWhatsappIngreso')->name('facturas.tirilla.whatsapp.ingreso');
...
Route::get('/GoogleAnalytics', 'GoogleAnalyticsController@index')->name('Google.index');
    ...
    Route::get('iniciar/{id}', 'ContratosController@contratoIniciar')->name('contrato.iniciar');
	...
	Route::resource('estadisticas', 'StatisticsController');
	...
	//PLANES DE VELOCIDAD
        Route::group(['prefix' => 'planes-velocidad'], function (){
            ...
            Route::post('copy-plan', 'PlanesVelocidadController@copy')->name('planes-velocidad.copyPlan');
...
Route::post('/upload/payment-proof', [\App\Http\Controllers\SubscriptionActiveController::class,'sendNotificationEmail'])->name('upload.payment.proof');
