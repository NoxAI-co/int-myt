...
class Empresa extends Model
{
     ...
     */
    protected $fillable = [
        'nombre', 'logo', 'nit', 'direccion', 'telefono', 'email', 'tip_iden', 'tipo_persona', 
        'status', 'terminos_cond', 'notas_fact', 'edo_cuenta_fact', 'moneda', 'created_at', 
        'updated_at', 'web', 'precision', 'sep_dec', 'carrito', 'img_default', 'rol', 'dv', 
        'fk_idpais', 'fk_iddepartamento', 'fk_idmunicipio', 'cod_postal', 'json_test_creditnote', 
