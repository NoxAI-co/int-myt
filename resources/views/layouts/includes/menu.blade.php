...
@elseif(Auth::user()->rol >= 2 )
    ...
    <li class="nav-item" id="asignacion">
        <a class="nav-link"  href="{{route('asignaciones.index')}}" aria-controls="ui-asignacion">
            <i class="menu-icon fas fa-file-contract"></i>
            <span class="menu-title">Contrato Digital</span>
        </a>
    </li>
@endif
        ...
        <li class="nav-item" id="mikrotik">
            <a class="nav-link" data-toggle="collapse" href="#ui-mikrotik" aria-expanded="false" aria-controls="ui-mikrotik">
                <i class="menu-icon fas fa-server"></i>
                    <span class="menu-title">Servidor</span>
                <i class="menu-arrow"></i>
            </a>
        ...
        <li class="nav-item" id="avisos">
            <a class="nav-link" data-toggle="collapse" href="#ui-avisos" aria-expanded="false" aria-controls="ui-avisos">
                <i class="menu-icon fas fa-file-code"></i>
                    <span class="menu-title">Administración de Avisos</span>
                <i class="menu-arrow"></i>
            </a>
    ...
    <li id="nomina" class="nav-item">
        ...
        <a class="nav-link" data-toggle="collapse" href="#ui-nomina" aria-expanded="false" aria-controls="ui-nomina">
            ...
            <span class="menu-title">Nómina Electronica
        ...
        <li class="nav-item" id="auditoria">
            <a class="nav-link" data-toggle="collapse" href="#ui-auditoria" aria-expanded="false" aria-controls="ui-auditoria">
                <i class="menu-icon fas fa-user-secret"></i>
                    <span class="menu-title">Inspección</span>
                <i class="menu-arrow"></i>
            </a>
