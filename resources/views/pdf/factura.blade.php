    ...
    <div style="">
        <table border="0" class="titulo">
            ...
            <tr>
                ...
                <td colspan="3" style="border-top: 2px solid #ccc;">{{$factura->cliente()->nombre}} {{ $factura->cliente()->apellido1 }}</td>
        ...
        <table border="0" class="desgloce" >
            ...
            <tfoot>
                ...
                <tr class="foot">
                    ...
                    <th class="center padding-right">{{Auth::user()->empresa()->moneda}}{{App\Funcion::Parsear($factura->total()->total + $factura->estadoCuenta()->saldoMesAnterior)}} </th>
                </tr>
            </tfoot>
        </table>
