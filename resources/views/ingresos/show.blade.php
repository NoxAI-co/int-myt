	...
	@else
	    @if($ingreso->tipo==1)
	        ...
	        @if($ingreso->ingresofactura())
	            ...
	            <a href="{{route('facturas.tirilla.whatsapp.ingreso', ['id' => $ingreso->nro, 'name' => $ingreso->ingresofactura()->factura()->id])}}" class="btn btn-success @if(Auth::user()->rol==47) btn-xl @else btn-xs @endif" title="Tirilla" target="_blank" id="btn_tirilla"><i class="fab fa-whatsapp"></i>Enviar tirilla por Whatsapp</a>
	        @endif
	        {{-- @endif --}}
	    @endif
