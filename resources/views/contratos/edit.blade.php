                ...
                <div class="tab-content fact-table" id="myTabContent">
                    <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <label class="control-label">Fecha de Creación contrato <a><i data-tippy-content="Arrastre el pin para indicar las coordenadas deseadas." class="icono far fa-question-circle"></i></a></label>
                                <div class="input-group">
                                    <input type="date" class="form-control" id="fecha_inicio_contrato" name="fecha_inicio_contrato" value="{{ $contrato->fecha_inicio_contrato }}">
                                </div>
                            </div>
