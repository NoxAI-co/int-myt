...
@section('content')
    ...
    <form method="POST" action="{{ route('contratos.update', $contrato->id) }}" style="padding: 2% 3%;" role="form"
        class="forms-sample" novalidate id="form-contrato" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row card-description p-0">
            <div class="col-md-4 form-group">
                ...
                <input type="text" class="form-control readonly" id="nombre" name="nombre" required=""
                    value="{{ $contrato->nombre }} {{ $contrato->apellido1 }} {{ $contrato->apellido2 }}" maxlength="200"
                    readonly="">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" class="form-control readonly" id="ident" name="ident" readonly=""
                    value="{{ $contrato->nit }}" maxlength="20">
                <span class="help-block error">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" class="form-control" id="nro" name="nro" value="{{ $contrato->nro }}"
                    maxlength="200" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                <span class="help-block error">
                ...
                <div class="tab-content fact-table" id="myTabContent">
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group">
                                    <select class="form-control selectpicker" name="grupo_corte" id="grupo_corte"
                                        required="" title="Seleccione" data-live-search="true" data-size="5">
                                        @foreach ($grupos as $grupo)
                                            <option value="{{ $grupo->id }}"
                                                {{ $grupo->id == $contrato->grupo_corte ? 'selected' : '' }}>
                                                {{ $grupo->nombre }} (Corte {{ $grupo->fecha_corte }} - Suspensión
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group">
                                    <select class="form-control selectpicker" name="facturacion" id="facturacion"
                                        ...
                                        <option value="1" {{ $contrato->facturacion == 1 ? 'selected' : '' }}>
                                            Facturación Estándar</option>
                                        <option value="3" {{ $contrato->facturacion == 3 ? 'selected' : '' }}>
                                            Facturación Electrónica</option>
                                    </select>
                                </div>
                                <span class="help-block error">
                            ...
                            <div class="col-md-4 form-group" id="div_facturacion">
                                ...
                                <div class="input-group">
                                    <select class="form-control selectpicker" name="factura_individual"
                                        ...
                                        <option value="1" {{ $contrato->factura_individual == 1 ? 'selected' : '' }}>
                                            Si</option>
                                        <option value="0" {{ $contrato->factura_individual == 0 ? 'selected' : '' }}>
                                            No</option>
                                    </select>
                                </div>
                                <span class="help-block error">
                            ...
                            <div class="col-md-4 form-group">
                                <label class="control-label">Fecha de Suspensión <a><i
                                            data-tippy-content="Fecha de suspensión personalizada, distinta a la asociada al grupo de corte"
                                            class="icono far fa-question-circle"></i></a></label>
                                <input type="number" class="form-control" id="fecha_suspension"
                                    value="{{ $contrato->fecha_suspension }}" name="fecha_suspension" min="1"
                                    max="30">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select class="form-control selectpicker" id="contrato_permanencia"
                                    ...
                                    data-live-search="true" data-size="5">
                                    <option value="1" {{ $contrato->contrato_permanencia == '1' ? 'selected' : '' }}>
                                        SI
                                    </option>
                                    <option value="0" {{ $contrato->contrato_permanencia == '0' ? 'selected' : '' }}>
                                        NO
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 form-group {{ old('contrato_permanencia') == 1 || $contrato->contrato_permanencia == 1 ? '' : 'd-none' }}"
                                id="div_meses">
                                ...
                                <div class="input-group">
                                    <select class="form-control selectpicker" id="contrato_permanencia_meses"
                                        ...
                                        data-live-search="true" data-size="5">
                                        <option value="3"
                                            {{ $contrato->contrato_permanencia_meses == 3 ? 'selected' : '' }}>3 meses
                                        </option>
                                        <option value="6"
                                            {{ $contrato->contrato_permanencia_meses == 6 ? 'selected' : '' }}>6 meses
                                        </option>
                                        <option value="9"
                                            {{ $contrato->contrato_permanencia_meses == 9 ? 'selected' : '' }}>9 meses
                                        </option>
                                        <option value="12"
                                            {{ $contrato->contrato_permanencia_meses == 12 ? 'selected' : '' }}>12 meses
                                        </option>
                                    </select>
                                </div>
                                <span class="help-block error">
                            ...
                            <div class="col-md-4 form-group d-none" id="div_opciones">
                                <label
                                    class="control-label">{{ $contrato->opciones_dian == 0 ? 'Habilitar' : 'Deshabilitar' }}
                                    opciones de facturacion electórnica?</label>
                                <div class="input-group">
                                    <a href="#" onclick="hab_desha()" class="btn btn-outline-primary"
                                        style="width:100%;">{{ $contrato->opciones_dian == 0 ? 'Habilitar' : 'Deshabilitar' }}</a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="us2-lat" name="contrasena_wifi"
                                        value="{{ $contrato->contrasena_wifi }}">
                                </div>
                            </div>
                            <div class="col-md-4 form-group">
                                <label class="control-label">Fecha de Creación contrato <a><i
                                            data-tippy-content="Arrastre el pin para indicar las coordenadas deseadas."
                                            class="icono far fa-question-circle"></i></a></label>
                                <div class="input-group">
                                    <input type="date" class="form-control" id="fecha_inicio_contrato"
                                        name="fecha_inicio_contrato" value="{{ $contrato->fecha_inicio_contrato }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                                    ...
                                    <select class="form-control selectpicker" name="server_configuration_id"
                                        ...
                                        @foreach ($servidores as $servidor)
                                            <option value="{{ $servidor->id }}"
                                                {{ $servidor->id == $contrato->server_configuration_id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control selectpicker" name="plan_id" id="plan_id"
                                        ...
                                        @foreach ($planes as $plan)
                                            <option value="{{ $plan->id }}"
                                                {{ $plan->id == $contrato->plan_id ? 'selected' : '' }}>
                                                {{ $plan->type() }}:
                                                {{ $plan->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select class="form-control selectpicker" id="conexion" name="conexion" required=""
                                    ...
                                    <option value="3" {{ $contrato->conexion == 3 ? 'selected' : '' }}>IP Estática
                                    </option>
                                    <option value="4" {{ $contrato->conexion == 4 ? 'selected' : '' }}>VLAN</option>
                                </select>
                                <input type="hidden" name="amarre_mac" id="amarre_mac">
                            </div>
                            <div class="col-md-4 form-group {{ $contrato->conexion == 2 ? '' : 'd-none' }}"
                                id="div_dhcp">
                                ...
                                <select class="form-control selectpicker" id="simple_queue" name="simple_queue"
                                    ...
                                    <option value="dinamica"
                                        {{ $contrato->simple_queue == 'dinamica' ? 'selected' : '' }}>
                                        Dinámica</option>
                                    <option value="estatica"
                                        {{ $contrato->simple_queue == 'estatica' ? 'selected' : '' }}>
                                        Estática</option>
                                </select>
                            </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control selectpicker" name="interfaz" id="interfaz"
                                        ...
                                        @foreach ($interfaces as $interfaz)
                                            <option value="{{ $interfaz->name }}"
                                                {{ $interfaz->name == $contrato->interfaz ? 'selected' : '' }}>
                                                {{ $interfaz->name }}</option>
                                        @endforeach
                                    </select>
                                    <span class="help-block error">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="ip"
                                        value="{{ $contrato->ip }}" id="ip" required=""
                            ...
                            <div class="col-md-4 form-group  {{ $contrato->local_address_new ? '' : 'd-none' }}"
                                id="new_segmento">
                                <label class="control-label">Segmento de IP</label>
                                <input type="text" class="form-control" name="local_address_new"
                                    value="{{ $contrato->local_address_new }}" id="local_address_new"
                            ...
                            <div class="col-md-4 form-group  {{ $contrato->ip_new ? '' : 'd-none' }}" id="new_ip">
                                <label class="control-label" id="div_ip">Dirección IP (Remote Address) <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" class="form-control" name="ip_new"
                                        value="{{ $contrato->ip_new }}" id="ip_new" required=""
                                        onkeypress="return event.charCode >= 48 && event.charCode <=57 || event.charCode==46">
                                    <div class="input-group-append">
                            ...
                            <div class="col-md-4 form-group  {{ $contrato->conexion == 1 ? '' : 'd-none' }}"
                                id="local_adress" {{ $contrato->local_adress_pppoe ? '' : 'd-none' }}>
                                ...
                                <input type="text" class="form-control" name="direccion_local_address"
                                    id="local_address" value="{{ $contrato->local_adress_pppoe }}"
                                    onkeypress="return event.charCode >= 48 && event.charCode <=57 || event.charCode==46 || event.charCode==47">
                            </div>

                            <div class="col-md-4 form-group  {{ $contrato->conexion == 1 ? '' : 'd-none' }}"
                                id="div_profile" {{ $contrato->profile ? '' : 'd-none' }}>
                                <label class="control-label">Profile</label>
                                <input type="text" class="form-control" name="profile" id="profile"
                                    value="{{ $contrato->profile }}">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select class="form-control selectpicker" id="tecnologia" name="tecnologia"
                                    ...
                                    <option value="1" {{ $contrato->tecnologia == 1 ? 'selected' : '' }}>Fibra
                                    </option>
                                    <option value="2" {{ $contrato->tecnologia == 2 ? 'selected' : '' }}>Inalámbrico
                                    </option>
                                </select>
                                <span class="help-block error">
                            ...
                            <div class="col-md-4 form-group d-none" id="puerto_receptor">
                                ...
                                <input type="text" class="form-control" name="puerto_receptor" id="puerto_receptor"
                                    value="{{ $contrato->puerto_receptor }}">
                                <span class="help-block error">
                            ...
                            <div class="col-md-4 form-group {{ $contrato->conexion == 1 ? 'd-none' : '' }}"
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control mac_address" name="mac_address"
                                        id="mac_address" value="{{ $contrato->mac_address }}">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-success btn-sm" type="button" id="searchMAC"
                                            style="border-radius: 0 5px 5px 0;"><i class="fa fa-search"
                                                style="margin: 2px;"></i></button>
                                    </div>
                                    <span class="help-block error">
                                    ...
                                    <select class="form-control selectpicker" name="puerto_conexion" id="puerto_conexion"
                                        ...
                                        @foreach ($puertos as $puerto)
                                            <option value="{{ $puerto->id }}"
                                                {{ $puerto->id == $contrato->puerto_conexion ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3 form-group d-none">
                                ...
                                <select class="form-control selectpicker" id="marca_router" name="marca_router"
                                    required="" value="{{ $contrato->marca_router }}" title="Seleccione">
                                    @foreach ($marcas as $marca)
                                        <option value="{{ $marca->id }}"
                                            {{ $marca->id == $contrato->marca_router ? 'selected' : '' }}>
                                            {{ $marca->nombre }}</option>
                                    @endforeach
                                </select>
                                <span class="help-block error">
                            ...
                            <div class="col-md-3 form-group d-none">
                                ...
                                <input type="text" class="form-control" id="modelo_router" name="modelo_router"
                                    required="" value="{{ $contrato->modelo_router }}" required="">
                                <span class="help-block error">
                            ...
                            <div class="col-md-3 form-group d-none">
                                ...
                                <select class="form-control selectpicker" id="marca_antena" name="marca_antena"
                                    required="" value="{{ $contrato->marca_antena }}" title="Seleccione">
                                    @foreach ($marcas as $marca)
                                        <option value="{{ $marca->id }}"
                                            @if ($marca->id == $contrato->marca_antena) ? selected : '' @endif>{{ $marca->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                                <span class="help-block error">
                            ...
                            <div class="col-md-3 form-group d-none">
                                ...
                                <input type="text" class="form-control" id="modelo_antena" name="modelo_antena"
                                    required="" value="{{ $contrato->modelo_antena }}" required="">
                                <span class="help-block error">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-radio">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="iva_factura"
                                                    id="iva_factura1" value="1"
                                                    {{ $contrato->iva_factura == 1 ? 'checked' : '' }}> Si
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-radio">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="iva_factura"
                                                    id="iva_factura2" value="0"
                                                    {{ $contrato->iva_factura == 0 ? 'checked' : '' }}> No
                                                <i class="input-helper"></i><i class="input-helper"></i></label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control selectpicker" name="servicio_tv" id="servicio_tv"
                                        ...
                                        @foreach ($servicios as $servicio)
                                            <option value="{{ $servicio->id }}"
                                                {{ $servicio->id == $contrato->servicio_tv ? 'selected' : '' }}>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" id="olt_sn_mac" name="olt_sn_mac"
                                        value="{{ $contrato->olt_sn_mac }}" maxlength="200">
                                    <span class="help-block error">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control selectpicker" name="state_olt_catv" id="state_olt_catv"
                                        ...
                                        <option value="1" {{ 1 == $contrato->state_olt_catv ? 'selected' : '' }}>
                                            HABILITADO</option>
                                        <option value="0" {{ 0 == $contrato->state_olt_catv ? 'selected' : '' }}>
                                ...
                                <select class="form-control selectpicker" name="servicio_otro" id="servicio_otro"
                                    ...
                                    @foreach ($serviciosOtros as $servicioOtro)
                                        <option value="{{ $servicioOtro->id }}"
                                            {{ $servicioOtro->id == $contrato->servicio_otro ? 'selected' : '' }}>
                    ...
                    <div class="tab-pane fade" id="adicionales" role="tabpanel" aria-labelledby="adicionales-tab">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group mb-2">
                                    <input type="number" class="form-control" id="descuento" name="descuento"
                                        required="" value="{{ $contrato->descuento }}"
                                    ...
                                    <select class="form-control selectpicker" name="vendedor" id="vendedor"
                                        ...
                                        @foreach ($vendedores as $vendedor)
                                            <option value="{{ $vendedor->id }}"
                                                {{ $contrato->vendedor == $vendedor->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control selectpicker" name="canal" id="canal"
                                        ...
                                        @foreach ($canales as $canal)
                                            <option value="{{ $canal->id }}"
                                                {{ $contrato->canal == $canal->id ? 'selected' : '' }}>
                                                {{ $canal->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group mb-2">
                                    <select class="form-control selectpicker" name="reconexion" id="reconexion"
                                        title="Seleccione">
                                        <option value="1" {{ $contrato->costo_reconexion > 0 ? 'selected' : '' }}>Si
                                        </option>
                                        <option value="0" {{ $contrato->costo_reconexion == 0 ? 'selected' : '' }}>
                                            No
                                        </option>
                                    </select>
                                    <span style="color: red;">
                            ...
                            <div class="col-md-4 form-group {{ $contrato->costo_reconexion > 0 ? '' : 'd-none' }}"
                                id="div_reconexion">
                                ...
                                <div class="input-group mb-2">
                                    <input type="number" class="form-control" id="costo_reconexion"
                                        ...
                                        onkeypress="return event.charCode >= 48 && event.charCode <=57" min="0"
                                        value="{{ $contrato->costo_reconexion }}">
                                    <span style="color: red;">
                                ...
                                <div class="input-group mb-2">
                                    <select class="form-control selectpicker" name="tipo_contrato" id="tipo_contrato"
                                        ...
                                        <option value="instalacion"
                                            {{ $contrato->tipo_contrato == 'instalacion' || $contrato->tipo_contrato == null ? 'selected' : '' }}>
                                            Instalación</option>
                                        <option value="reconexion"
                                            {{ $contrato->tipo_contrato == 'reconexion' ? 'selected' : '' }}>Reconexión
                                        </option>
                                        <option value="cambio titular del servicio"
                                            {{ $contrato->tipo_contrato == 'cambio titular del servicio' ? 'selected' : '' }}>
                                            Cambio titular del servicio</option>
                                    </select>
                                    <span style="color: red;">
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label">¿Agregar fechas de No suspensión? <a><i
                                            data-tippy-content="Decida si este cnotrato tendrá un rango de fechas donde si tiene facturas abiertas no lo suspenderá (esto solo pasará en el rango escogido)"
                                            class="icono far fa-question-circle"></i></a></label>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-radio">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="tipo_suspension_no"
                                                    id="tipo_suspension_no1" value="1"
                                                    {{ $contrato->tipo_nosuspension == 1 ? 'checked' : '' }}> Si
                                                <i class="input-helper"></i><i class="input-helper"></i></label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-radio">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="tipo_suspension_no"
                                                    id="tipo_suspension_no2" value="0"
                                                    {{ $contrato->tipo_nosuspension == 0 ? 'checked' : '' }}> No
                                                <i class="input-helper"></i><i class="input-helper"></i></label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 form-group">
                                <div @if ($contrato->tipo_nosuspension == 0) class="cls-nosuspension d-none" @endif>
                                    ...
                                    <input type="date" class="form-control" id="fecha_desde_nosuspension"
                                        value="{{ $contrato->fecha_desde_nosuspension }}"
                                        name="fecha_desde_nosuspension">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                <div @if ($contrato->tipo_nosuspension == 0) class="cls-nosuspension d-none" @endif>
                                    ...
                                    <input type="date" class="form-control" id="fecha_hasta_nosuspension"
                                        value="{{ $contrato->fecha_hasta_nosuspension }}"
                                        name="fecha_hasta_nosuspension">
                                </div>
                            </div>
